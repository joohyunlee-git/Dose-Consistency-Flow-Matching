...
from flow_matching.path.scheduler.scheduler import Scheduler, ConvexScheduler, CondOTScheduler, PolynomialConvexScheduler, VPScheduler, LinearVPScheduler, CosineScheduler
...
class ConvexProbPath(AffineProbPath):

    def __init__(self):
        self.scheduler = ConvexScheduler()
...
class PolynomialConvexProbPath(AffineProbPath):

    def __init__(self):
        self.scheduler = PolynomialConvexScheduler()


class VPProbPath(AffineProbPath):

    def __init__(self):
        self.scheduler = VPScheduler()


class LinearVPProbPath(AffineProbPath):

    def __init__(self):
        self.scheduler = LinearVPScheduler()


class CosineProbPath(AffineProbPath):
